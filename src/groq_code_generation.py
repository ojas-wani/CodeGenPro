...
os.environ["GROQ_API_KEY"] = "GROR_API_KEY"  # Replace GROR_API_KEY with your API key
...
def generate_code(output_dir, lang="python"):
    ...
    for task_meta in tasks_meta_lists:
        ...
        messages_prompt = f"Please provide a code function implementation of the following description:\n{task_description}"
