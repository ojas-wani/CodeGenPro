...
class AutoLeetCode:
    ...
    def run_and_collect(self, task_info: dict, language: str, code: str):
        ...
        try:
            ...
            self.browser.save_screenshot(
                f"LLM-Improved-Code-Quality/test_data/temp/submissions/submission-errors/{task_info['id']}_timeout_submission_result.png")
    ...
    def submit_and_collect(self, task_info: dict, language: str, code: str):
        ...
        try:
            ...
            try:
                ...
                if wrong_answer_element:
                    ...
                    self.browser.save_screenshot(
                        f"LLM-Improved-Code-Quality/test_data/temp/submissions/submission-errors/python/wrong_answer/{task_info['id']} + {task_info['task_name']}.png")
                    ...
                    print("++++++++++++++++++++++", runtime_error_elements)
                    if runtime_error_elements:
                        result_text = "Runtime Error"
                        logging.error('Runtime Error: %s',
                                      runtime_error_elements[0].text)
                        self.browser.save_screenshot(
                            f"LLM-Improved-Code-Quality/test_data/temp/submissions/submission-errors/python/runtime_error/{task_info['id']} + {task_info['task_name']}.png")
                    else:
                        result_text = "Timeout"
        ...
        self.append_row_excel(
            "LLM-Improved-Code-Quality/test_data/temp/submissions/submission_results.xlsx", task_info)
