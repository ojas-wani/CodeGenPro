...
def run_pylint():
    ...
    """
    code_dir = "LLM-Improved-Code-Quality/test_data/temp2/updated_code/code/python/"
    generated_report_dir = "LLM-Improved-Code-Quality/test_data/temp2/updated_code/reports/python/pylint/"
...
def run_flake8_python():
    ...
    """
    code_dir = "LLM-Improved-Code-Quality/test_data/temp2/updated_code/code/python/"
    generated_report_dir = "LLM-Improved-Code-Quality/test_data/temp2/updated_code/reports/python/flake8/"
    ...
    for file in os.listdir(code_dir):
        if file.endswith(".py"):
            ...
            out, err = command_with_timeout(
                ["flake8", code_dir + file], timeout=10)
            with open(generated_report_dir + name + ".txt", "w") as f:
                f.write(out)
...
def run_pmd_java():
    ...
    """
    code_dir = "LLM-Improved-Code-Quality/test_data/temp2/updated_code/code/java/"
    generated_report_dir = "LLM-Improved-Code-Quality/test_data/temp2/updated_code/reports/java/pmd/"
    ...
    for file in os.listdir(code_dir):
        ...
        smell_txt = generated_report_dir + file.split(".")[0] + ".txt"
        # os.system(
        # "pmd check -d {} -R rulesets/java/all.xml -f text -r {}".format(file_path, smell_txt))
        os.system(
            "pmd check -d {} -R ChatGPT-CodeGenAnalysis-main/src/evaluation/rulesets-pmd/java/all.xml -f text -r {}".format(file_path, smell_txt))
...
def run_checkstyle_java():
    ...
    """
    code_dir = "LLM-Improved-Code-Quality/test_data/temp2/updated_code/code/java/"
    generated_report_dir = "LLM-Improved-Code-Quality/test_data/temp2/updated_code/reports/java/checkstyle/"
    ...
    for file in os.listdir(code_dir):
        if file.endswith(".java"):
            ...
            smell_txt = generated_report_dir + file.split(".")[0] + ".txt"
            out, err = command_with_timeout(
                ["java", "-jar", "LLM-Improved-Code-Quality/src/evaluation/checkstyle/checkstyle-10.9.3-all.jar",
                    "-c", "LLM-Improved-Code-Quality/src/evaluation/checkstyle/sun_checks.xml", file_path],
                timeout=5
            )
            with open(smell_txt, "w") as f:
                f.write(str(out))
